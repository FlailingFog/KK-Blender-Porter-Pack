...
class select_bones(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        allLayers = (True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True, True)
        bpy.ops.pose.bone_layers(layers=allLayers)
        
        #get the visible bones in pose mode then
